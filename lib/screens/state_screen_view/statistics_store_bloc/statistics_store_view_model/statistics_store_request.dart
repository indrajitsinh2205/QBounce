class PostStatisticsStoreRequestModel {
  ...
  PostStatisticsStoreRequestModel({
  ...
  factory PostStatisticsStoreRequestModel.fromJson(Map<String, dynamic> json) {
    return PostStatisticsStoreRequestModel(
