...
import 'PostStatisticsStoreResponse.dart';




class StatisticsStoreViewModel extends ChangeNotifier {
  ...
  Future<PostStatisticsStoreResponse?> postStatisticsStore(PostStatisticsStoreRequestModel postData) async {
    _isLoading = true;
    _errorMessage = null;
    notifyListeners();
    ...
    try {
      final endpoint = StatisticsApiEndpoint(
        StatisticsType.statisticsStore,
      ...
      if (response.statusCode == 200) {
        ...
        PostStatisticsStoreResponse postStatisticsStoreResponse = PostStatisticsStoreResponse.fromJson(jsonResponse);

        print("statistics: ${postStatisticsStoreResponse.data}");
        return postStatisticsStoreResponse;
      }
      else {
        print("error");
